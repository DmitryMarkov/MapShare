...
function scaleBannerVideoSize(t) {
  var n, s, e = $(window).width(), i = $(window).height() + 5;
  $(t).each(function() {
...
function upTo(t, e) {
  for (e = e.toLowerCase(); t && t.parentNode; )
    if (t = t.parentNode,
    t.tagName && t.tagName.toLowerCase() == e)
      return t;
  return null
}
(function() {
  ...
  var t = this
    ...
    return s = this.width = t.canvas.width,
  ...
  n.calculateOrderOfMagnitude = function(t) {
    ...
    h === u && (h += .5,
    u >= .5 && !n ? u -= .5 : h += .5);
    for (var d = Math.abs(h - u), f = T(d), p = Math.ceil(h / (1 * Math.pow(10, f))) * Math.pow(10, f), v = n ? 0 : Math.floor(u / (1 * Math.pow(10, f))) * Math.pow(10, f), g = p - v, m = Math.pow(10, f), w = Math.round(g / m); (w > r || r > 2 * w) && !l; )
      if (w > r)
        m *= 2,
        w = Math.round(g / m),
        w % 1 !== 0 && (l = !0);
  ...
  n.animationLoop = function(t, e, i, n, s, a) {
    var o = 0
      ...
      t.call(a, c, i, o),
      n.call(a, c, i),
      e > o ? a.animationFrame = L(l) : s.apply(a)
    }
    ;
    L(l)
  }
  ...
  n.retinaScale = function(t) {
    ...
    , X = n.drawRoundedRectangle = function(t, e, i, n, s, a) {
    t.beginPath(),
    t.moveTo(e + a, i),
    t.lineTo(e + n - a, i),
      ...
      if (a || e) {
        ...
        t.length > 0)
          if (this.datasets && this.datasets.length > 1) {
            for (var o, r, c = this.datasets.length - 1; c >= 0 && (o = this.datasets[c].points || this.datasets[c].bars || this.datasets[c].segments,
            r = l(o, t[0]),
            -1 === r); c--)
              ;
            var u = []
  ...
  i.Scale = i.Element.extend({
    ...
    buildYLabels: function() {
      ...
      for (var t = x(this.stepValue), e = 0; e <= this.steps; e++)
        this.yLabels.push(M(this.templateString, {
    ...
    calculateXLabelRotation: function() {
      ...
      this.display) {
        var a, s = Q(this.ctx, this.font, this.xLabels);
        this.xLabelWidth = s;
  ...
  i.RadialScale = i.Element.extend({
    ...
    setScaleSize: function() {
      var e, i, n, s, o, r, c, u, h, d, f, p, t = b([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]), a = this.width, l = 0;
      ...
      i = 0; i < this.valuesCount; i++)
        ...
        n = this.ctx.measureText(M(this.templateString, {
          value: this.labels[i]
        })).width + 5,
        ...
        o = i) : i > this.valuesCount / 2 && e.x - n < l && (l = e.x - n,
        c = i);
      h = l,
          ...
          if (i > 0) {
            ...
            if (this.showLabels) {
              ...
              this.showLabelBackdrop) {
                ...
                t.fillRect(this.xCenter - r / 2 - this.backdropPaddingX, s - this.fontSize / 2 - this.backdropPaddingY, r + 2 * this.backdropPaddingX, this.fontSize + 2 * this.backdropPaddingY)
              }
              t.textAlign = "center",
              t.textBaseline = "middle",
...
function() {
  ...
  e.Type.extend({
    ...
    addData: function(t, i, n) {
      ...
      "undefined" == typeof t.color && (t.color = e.defaults.global.segmentColorDefault[s % e.defaults.global.segmentColorDefault.length],
...
!function(t, e, i, n) {
  ...
  function r(t, e, i) {
    for (var s = Object.keys(e), a = 0; a < s.length; )
      (!i || i && t[s[a]] === n) && (t[s[a]] = e[s[a]]),
      a++;
    return t
  }
  function l(t, e) {
  ...
  function P(t) {
    ...
    return new (e = i ? i : mt ? _ : yt ? j : gt ? N : W)(t,T)
  }
  function T(t, e, i) {
  ...
  function A(t, e) {
    ...
    s > 1 && !i.firstMultiple ? i.firstMultiple = E(e) : 1 === s && (i.firstMultiple = !1);
    var a = i.firstInput
      , o = i.firstMultiple
    ...
    e.scale = o ? V(o.pointers, n) : 1,
    e.rotation = o ? R(o.pointers, n) : 0,
    O(i, e);
    var c = t.element;
  ...
  function O(t, e) {
    var i, s, a, o, r = t.lastInterval || e, l = e.timeStamp - r.timeStamp;
  ...
  function R(t, e) {
    return D(e[1], e[0], Vt) - D(t[1], t[0], Vt)
  }
  function V(t, e) {
  ...
  function H(t, e) {
    ...
    return e & (Tt | At) && (i = w(i.concat(n), "identifier", !0)),
    [i, n]
  }
  function j() {
    this.evTarget = Gt,
  ...
  function B(t, e) {
    var i = b(t.touches)
      , n = this.targetIds;
    if (e & (St | Pt) && 1 === i.length)
      return n[i[0].identifier] = !0,
      [i, i];
    var s, a, o = b(t.changedTouches), r = [], l = this.target;
    ...
    e === St)
      for (s = 0; s < a.length; )
        ...
        s++;
    for (s = 0; s < o.length; )
      n[o[s].identifier] && r.push(o[s]),
      e & (Tt | At) && delete n[o[s].identifier],
      s++;
  ...
  function st(t, e) {
    return e = e || {},
    e.recognizers = d(e.recognizers, st.defaults.preset),
    new at(t,e)
  }
  function at(t, e) {
    e = e || {},
    this.options = l(e, st.defaults),
  ...
  t.MSPointerEvent && (Bt = "MSPointerDown",
  ...
  c(_, S, {
    handler: function(t) {
      var e = this.store
        ...
        , s = Ht[n]
        , a = jt[t.pointerType] || t.pointerType
        , o = a == bt
        , r = y(e, t.pointerId, "pointerId");
      s & St && (0 === t.button || o) ? 0 > r && (e.push(t),
      r = e.length - 1) : s & (Tt | At) && (i = !0),
      0 > r || (e[r] = t,
  ...
  c($, S, {
    handler: function(t) {
      ...
      this.started) {
        ...
        e & (Tt | At) && 0 === i[0].length - i[1].length && (this.started = !1),
        this.callback(this.manager, e, {
          pointers: i[0],
          changedPointers: i[1],
          pointerType: bt,
  ...
  X.prototype = {
    ...
    dropRecognizeWith: function(t) {
      return a(t, "dropRecognizeWith", this) ? this : (t = U(t, this),
    ...
    canEmit: function() {
      for (var t = 0; t < this.requireFail.length; ) {
        if (!(this.requireFail[t].state & (ue | se)))
          return !1;
        t++
      }
      return !0
    ...
    recognize: function(t) {
      var e = r({}, t);
      return h(this.options.enable, [this, e]) ? (this.state & (le | ce | ue) && (this.state = se),
      this.state = this.process(e),
      void (this.state & (ae | oe | re | ce) && this.tryEmit(e))) : (this.reset(),
      void (this.state = ue))
    },
    process: function() {},
  ...
  c(J, Z, {
    ...
    directionTest: function(t) {
      var e = this.options
        ...
        , a = t.deltaX
        , o = t.deltaY;
      return s & e.direction || (e.direction & It ? (s = 0 === a ? Mt : 0 > a ? Ot : Et,
      i = a != this.pX,
      n = Math.abs(t.deltaX)) : (s = 0 === o ? Mt : 0 > o ? Lt : Ft,
      i = o != this.pY,
      n = Math.abs(t.deltaY))),
      t.direction = s,
  ...
  c(tt, X, {
    ...
    emit: function(t) {
      this.state === le && (t && t.eventType & Tt ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = ft(),
  ...
  c(it, Z, {
    ...
    attrTest: function(t) {
      ...
      return i & (It | zt) ? e = t.velocity : i & It ? e = t.velocityX : i & zt && (e = t.velocityY),
      this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && dt(e) > this.options.velocity && t.eventType & Tt
    },
    emit: function(t) {
      var e = G(t.direction);
      e && this.manager.emit(this.options.event + e, t),
    ...
    recognize: function(t) {
      ...
      if (!e.stopped) {
        ...
        for (var a = 0; a < n.length; )
          i = n[a],
          e.stopped === de || s && i != s && !i.canRecognizeWith(s) ? i.reset() : i.recognize(t),
          !s && i.state & (ae | oe | re) && (s = e.curRecognizer = i),
          a++
      }
    },
    get: function(t) {
...
function() {
  ...
  e = function() {
    ...
    t.prototype.createEvent = function(t, e, i, n) {
      ...
      null  == i && (i = !1),
      null  == n && (n = null ),
      null  != document.createEvent ? (s = document.createEvent("CustomEvent"),
      s.initCustomEvent(t, e, i, n)) : null  != document.createEventObject ? (s = document.createEventObject(),
      s.eventType = t) : s.eventName = t,
      s
    }
    ,
    ...
    s.prototype.vendorSet = function(t, e) {
      ...
      for (i in e)
        ...
        n.push(function() {
          ...
          n = o.length; n > e; e++)
            a = o[e],
            r.push(t["" + a + i.charAt(0).toUpperCase() + i.substr(1)] = s);
          return r
        }
        .call(this));
      return n
...
function(t, e) {
  ...
  var e = function(t, e) {
    ...
    s.scale(a, a)),
    s.translate(e.size / 2, e.size / 2),
    s.rotate((-0.5 + e.rotate / 180) * Math.PI);
    var o = (e.size - e.lineWidth) / 2;
    e.scaleColor && e.scaleLength && (o -= e.scaleLength + 2),
    ...
    var r = function(t, e, i) {
      ...
      var t, i;
      s.lineWidth = 1,
      s.fillStyle = e.scaleColor,
      s.save();
      for (var n = 24; n > 0; --n)
        n % 6 === 0 ? (i = e.scaleLength,
        t = 0) : (i = .6 * e.scaleLength,
        t = e.scaleLength - i),
        s.fillRect(-e.size / 2 + t, 0, i, 1),
        s.rotate(Math.PI / 12);
      s.restore()
    }
      , c = function() {
    ...
    this.draw = function(t) {
      e.scaleColor || e.trackColor ? s.getImageData && s.putImageData ? i ? s.putImageData(i, 0, 0) : (u(),
      i = s.getImageData(0, 0, e.size * a, e.size * a)) : (this.clear(),
      u()) : this.clear(),
      s.lineCap = e.lineCap;
      var n;
    ...
    this.animate = function(t, i) {
      ...
      var s = function() {
        ...
        this.draw(o),
        e.onStep(t, i, o),
        a >= e.animate.duration ? e.onStop(t, i) : c(s)
      }
      .bind(this);
      c(s)
    }
    ...
    var s = {}
      ...
      this.options = s;
      for (var e in n)
        n.hasOwnProperty(e) && (s[e] = i && "undefined" != typeof i[e] ? i[e] : n[e],
        "function" == typeof s[e] && (s[e] = s[e].bind(this)));
      "string" == typeof s.easing && "undefined" != typeof jQuery && jQuery.isFunction(jQuery.easing[s.easing]) ? s.easing = jQuery.easing[s.easing] : s.easing = n.easing,
      ...
      this.renderer = new s.renderer(t,s),
    ...
    this.update = function(t) {
      ...
      s.animate.enabled ? this.renderer.animate(a, t) : this.renderer.draw(t),
      a = t,
      this
    }
    .bind(this),
    this.disableAnimation = function() {
      return s.animate.enabled = !1,
      this
    }
    ,
    this.enableAnimation = function() {
      return s.animate.enabled = !0,
      this
    }
    ,
    o()
...
function(t) {
  t(["jquery"], function(t) {
    return function() {
      ...
      function v(i) {
        for (var n = e.children(), s = n.length - 1; s >= 0; s--)
          g(t(n[s]), i)
      }
      function g(e, i, n) {
      ...
      function w(i) {
        ...
        function y() {
          c.hover(F, L),
          !s.onclick && s.tapToDismiss && c.click(E),
          s.closeButton && f && f.click(function(t) {
        ...
        function w() {
          ...
          s.timeOut > 0 && (r = setTimeout(E, s.timeOut),
          p.maxHideTime = parseFloat(s.timeOut),
          p.hideEta = (new Date).getTime() + p.maxHideTime,
          s.progressBar && (p.intervalId = setInterval(I, 10)))
        }
        function k() {
        ...
        function P() {
          i.title && (u.append(s.escapeHtml ? g(i.title) : i.title).addClass(s.titleClass),
          c.append(u))
        }
        function T() {
          i.message && (h.append(s.escapeHtml ? g(i.message) : i.message).addClass(s.messageClass),
          c.append(h))
        }
        function A() {
          s.closeButton && (f.addClass("toast-close-button").attr("role", "button"),
          c.prepend(f))
        }
        function M() {
          s.progressBar && (d.addClass("toast-progress"),
          c.prepend(d))
        }
        function O(t, e) {
        ...
        function E(e) {
          ...
          c[i]({
            ...
            complete: function() {
              C(c),
              s.onHidden && "hidden" !== v.state && s.onHidden(),
              v.state = "hidden",
              v.endTime = new Date,
              b(v)
            }
        ...
        function L() {
          (s.timeOut > 0 || s.extendedTimeOut > 0) && (r = setTimeout(E, s.extendedTimeOut),
          p.maxHideTime = parseFloat(s.extendedTimeOut),
          p.hideEta = (new Date).getTime() + p.maxHideTime)
        }
        function F() {
          clearTimeout(r),
          p.hideEta = 0,
          c.stop(!0, !0)[s.showMethod]({
            duration: s.showDuration,
            easing: s.showEasing
          })
        }
        ...
        if ("undefined" != typeof i.optionsOverride && (s = t.extend(s, i.optionsOverride),
...
function(t) {
  t.fn.collapsible = function(e) {
    ...
    this.each(function() {
      ...
      e.accordion || "accordion" === s || void 0 === s ? (n = i.find("> li > .collapsible-header"),
    ...
    init: function(e) {
      ...
      t(this).each(function() {
        ...
        n.hasClass("fixed") && t(window).resize(function() {
          window.innerWidth > 992 ? 0 !== t("#sidenav-overlay").css("opacity") && o ? s(!0) : (n.removeAttr("style"),
          n.css("width", e.menuWidth)) : o === !1 && ("left" === e.edge ? n.css("left", -1 * (e.menuWidth + 10)) : n.css("right", -1 * (e.menuWidth + 10)))
        }),
        ...
        t(".drag-target").hammer({
          ...
          if ("touch" == i.gesture.pointerType) {
            ...
            "left" === e.edge)
              r < e.menuWidth / 2 ? o = !1 : r >= e.menuWidth / 2 && (o = !0),
              n.css("left", r - e.menuWidth);
            else {
          ...
          if ("touch" == i.gesture.pointerType) {
            ...
            a = !1,
            "left" === e.edge ? o && .3 >= s || -.5 > s ? (n.velocity({
              left: 0
            }, {
              duration: 300,
              queue: !1,
...
function(t) {
  ...
  t.fn.extend({
    openModal: function(i) {
      ...
      o.data("overlay-id", a).css("z-index", 1e3 + 2 * l + 1),
      t("body").append(r),
      i = t.extend(s, i),
  ...
  t.fn.extend({
    closeModal: function(i) {
      ...
      i = t.extend(n, i),
      t("body").css("overflow", ""),
      s.find(".modal-close").off("click.close"),
    ...
    return this.each(function() {
      ...
      if (!t(this).hasClass("initialized")) {
        ...
        a.on("click", function() {
          ...
          g = .9 * r * f,
          m = .9 * r),
          a.hasClass("responsive-img") ? a.velocity({
            "max-width": g,
            width: l
          }, {
            duration: 0,
...
$(selector).on("click", function() {
  ...
  $(this).hasClass("active") ? ($(selector).removeClass("active"),
  $(".popout .panel").removeClass("active")) : ($(selector).removeClass("active"),
...
function(t) {
  ...
  function s(e, l, c, h) {
    ...
    function w() {
      g.data(l, y).addClass(v.input).attr("tabindex", -1).val(g.data("value") ? y.get("select", p.format) : e.value),
    ...
    function x() {
      y.$root.on({
        ...
        "mousedown click": function(e) {
          var i = e.target;
          i != y.$root.children()[0] && (e.stopPropagation(),
        ...
        var e = t(this)
          ...
          , s = u();
        s = s && (s.type || s.href),
        (n || s && !t.contains(y.$root[0], s)) && y.$root[0].focus(),
    ...
    function C() {
      var i;
      p.hiddenName === !0 ? (i = e.name,
      e.name = "") : (i = ["string" == typeof p.hiddenPrefix ? p.hiddenPrefix : "", "string" == typeof p.hiddenSuffix ? p.hiddenSuffix : "_submit"],
      i = i[0] + e.name + i[1]),
    ...
    function k(t) {
      var e = t.keyCode
        , i = /^(8|46)$/.test(e);
      return 27 == e ? (y.close(),
      !1) : void ((32 == e || i || !f.open && y.component.key[e]) && (t.preventDefault(),
      t.stopPropagation(),
      i ? y.clear().close() : y.open()))
    }
    function S(t) {
      t.stopPropagation(),
      "focus" == t.type && y.$root.addClass(v.focused),
      y.open()
    }
    if (!e)
      return s;
    var d = !1
      ...
      start: function() {
        ...
        y.component = new c(y,p),
        y.$root = t(s._.node("div", b(), v.picker, 'id="' + e.id + '_root" tabindex="0"')),
        x(),
        p.formatSubmit && C(),
        w(),
        ...
        d = a(y.$root.children()[0]),
        e.autofocus && y.open(),
        y.trigger("start").trigger("render"))
      },
      render: function(t) {
        return t ? y.$root.html(b()) : y.$root.find("." + v.box).html(y.component.nodes(f.open)),
        y.trigger("render")
      },
      stop: function() {
        ...
        y.$root.remove(),
        g.removeClass(v.input).removeData(l),
        setTimeout(function() {
          g.off("." + f.id)
        }, 0),
        e.type = f.type,
      ...
      open: function(a) {
        return f.open ? y : (g.addClass(v.active),
        r(e, "expanded", !0),
        setTimeout(function() {
        ...
        a !== !1 && (f.open = !0,
        d && n.css("overflow", "hidden").css("padding-right", "+=" + o()),
        y.$root[0].focus(),
        i.on("click." + f.id + " focusin." + f.id, function(t) {
          ...
          var i = e.keyCode
            , n = y.component.key[i]
            , a = e.target;
          27 == i ? y.close(!0) : a != y.$root[0] || !n && 13 != i ? t.contains(y.$root[0], a) && 13 == i && (e.preventDefault(),
          a.click()) : (e.preventDefault(),
          n ? s._.trigger(y.component.key.go, y, [s._.trigger(n)]) : y.$root.find("." + v.highlighted).hasClass(v.disabled) || y.set("select", y.component.item.highlight).close())
        })),
        y.trigger("open"))
      },
      close: function(t) {
        return t && (y.$root.off("focus.toOpen")[0].focus(),
        setTimeout(function() {
        ...
        f.open ? (f.open = !1,
        d && n.css("overflow", "").css("padding-right", "-=" + o()),
        i.off("." + f.id),
        y.trigger("close")) : y
      },
      clear: function(t) {
      ...
      set: function(e, i, n) {
        var s, a, o = t.isPlainObject(e), r = o ? e : {};
        if (n = o && t.isPlainObject(i) ? i : n || {},
        e) {
          o || (r[e] = i);
          for (s in r)
            a = r[s],
            s in y.component.item && (void 0 === a && (a = null ),
            y.component.set(s, a, n)),
            ("select" == s || "clear" == s) && g.val("clear" == s ? "" : y.get(s, p.format)).trigger("change");
          y.render()
        }
      ...
      off: function() {
        ...
        namesCount = i.length; t < namesCount; t += 1)
          e = i[t],
          e in f.methods && delete f.methods[e];
        return y
      },
  ...
  s._ = {
    group: function(t) {
      for (var e, i = "", n = s._.trigger(t.min, t); n <= s._.trigger(t.max, t, [n]); n += t.i)
        e = s._.trigger(t.item, t, [n]),
        i += s._.node(t.node, e[0], e[1], e[2]);
      return i
    },
...
function(t) {
  ...
  a.prototype.set = function(t, e, i) {
    ...
    s[t] = e,
    n) : (s["enable" == t ? "disable" : "flip" == t ? "enable" : t] = n.queue[t].split(" ").map(function(s) {
      return e = n[s](t, e, i)
    }).pop(),
    "select" == t ? n.set("highlight", s.select, i) : "highlight" == t ? n.set("view", s.highlight, i) : t.match(/^(flip|min|max|disable|enable)$/) && (s.select && n.disabled(s.select) && n.set("select", s.select, i),
    s.highlight && n.disabled(s.highlight) && n.set("highlight", s.highlight, i)),
    n)
  }
  ,
  ...
  a.prototype.create = function(t, i, n) {
    ...
    i == -(1 / 0) || i == 1 / 0 ? a = i : e.isPlainObject(i) && s.isInteger(i.pick) ? i = i.obj : e.isArray(i) ? (i = new Date(i[0],i[1],i[2]),
    i = s.isDate(i) ? i : o.create().obj) : i = s.isInteger(i) || s.isDate(i) ? o.normalize(new Date(i), n) : o.now(t, i, n),
    {
  ...
  a.prototype.createRange = function(t, i) {
    ...
    ;
    return s.isInteger(t) || (t = a(t)),
    s.isInteger(i) || (i = a(i)),
    s.isInteger(t) && e.isPlainObject(i) ? t = [i.year, i.month, i.date + t] : s.isInteger(i) && e.isPlainObject(t) && (i = [t.year, t.month, t.date + i]),
    {
      from: a(t),
      to: a(i)
    }
  ...
  a.prototype.navigate = function(t, i, n) {
    var s, a, o, r, l = e.isArray(i), c = e.isPlainObject(i), u = this.item.view;
    if (l || c) {
      for (c ? (a = i.year,
      o = i.month,
      r = i.date) : (a = +i[0],
      o = +i[1],
      r = +i[2]),
      n && n.nav && u && u.month !== o && (a = u.year,
      o = u.month),
      s = new Date(a,o + (n && n.nav ? n.nav : 0),1),
      a = s.getFullYear(),
      o = s.getMonth(); new Date(a,o,r).getMonth() !== o; )
        r -= 1;
      i = [a, o, r]
    }
    return i
  ...
  a.prototype.validate = function(t, i, n) {
    var c, u, f, p, a = this, o = i, r = n && n.interval ? n.interval : 1, l = -1 === a.item.enable, h = a.item.min, d = a.item.max, v = l && a.item.disable.filter(function(t) {
      if (e.isArray(t)) {
    ...
    if ((!n || !n.nav) && (!l && a.disabled(i) || l && a.disabled(i) && (v || c || u) || !l && (i.pick <= h.pick || i.pick >= d.pick)))
      for (l && !v && (!u && r > 0 || !c && 0 > r) && (r *= -1); a.disabled(i) && (Math.abs(r) > 1 && (i.month < o.month || i.month > o.month) && (i = o,
      r = r > 0 ? 1 : -1),
      i.pick <= h.pick ? (f = !0,
      r = 1,
  ...
  a.prototype.isDateOverlap = function(t, i) {
    ...
    return s.isInteger(t) && (s.isDate(i) || e.isArray(i)) ? (t = t % 7 + a,
    t === n.create(i).day + 1) : s.isInteger(i) && (s.isDate(t) || e.isArray(t)) ? (i = i % 7 + a,
    ...
    a = []) : i.map(function(t) {
      ...
      for (l = 0; o > l; l += 1) {
        ...
        if (n.isDateOverlap(r, t)) {
          ...
          i = t) : e.isArray(t) ? (i = t,
          i[3] || i.push("inverted")) : s.isDate(t) && (i = [t.getFullYear(), t.getMonth(), t.getDate(), "inverted"]);
          break
        }
      }
      if (i)
  ...
  a.prototype.nodes = function(t) {
    var e = this
      ...
      e.push(e.shift())),
      s.node("thead", s.node("tr", s.group({
        min: 0,
        max: i - 1,
        i: 1,
        node: "th",
      ...
      return "short_months" == i && (n = a.monthsShort),
      a.selectMonths && void 0 == i ? s.node("select", s.group({
        min: 0,
        max: 11,
        i: 1,
        node: "option",
...
function() {
  ...
  function C(e, n) {
    function W(t, e) {
      ...
      if (!e || !(g - y > p || p > g + y)) {
        ...
        i.off(c).on(c, function(t) {
          ...
          (e || m) && a === d && r === f && M.setHand(a, r),
          "hours" === M.currentView ? M.toggleView("minutes", w / 2) : n.autoclose && (M.minutesView.addClass("clockpicker-dial-out"),
          setTimeout(function() {
            M.done()
          }, w / 2)),
          o.prepend(_),
          clearTimeout(b),
          M.popover.removeClass("clockpicker-moving"),
          i.off(l)
        })
      }
    }
    ...
    n.twelvehour) {
      ...
      t('<div id="click-am">AM</div>').on("click", function() {
        M.spanAmPm.children("#click-am").addClass("text-primary"),
        M.spanAmPm.children("#click-pm").removeClass("text-primary"),
        M.amOrPm = "AM"
      }).appendTo(this.spanAmPm),
      t('<div id="click-pm">PM</div>').on("click", function() {
        M.spanAmPm.children("#click-pm").addClass("text-primary"),
        M.spanAmPm.children("#click-am").removeClass("text-primary"),
        M.amOrPm = "PM"
        ...
        M.amOrPm = "AM",
        M.amPmBlock.children(".pm-button").removeClass("active"),
        M.amPmBlock.children(".am-button").addClass("active"),
        M.spanAmPm.empty().append("AM")
      }).appendTo(this.amPmBlock),
      t('<button type="button" class="btn-floating btn-flat clockpicker-button pm-button" tabindex="2">PM</button>').on("click", function() {
        M.amOrPm = "PM",
        M.amPmBlock.children(".am-button").removeClass("active"),
        M.amPmBlock.children(".pm-button").addClass("active"),
        M.spanAmPm.empty().append("PM")
      }).appendTo(this.amPmBlock))
    }
    ...
    var I, z, D, R, F = t('<div class="clockpicker-tick"></div>');
    if (n.twelvehour)
      for (I = 1; 13 > I; I += 1)
        z = F.clone(),
        D = I / 6 * Math.PI,
        ...
        z.css("font-size", "140%"),
        z.css({
          left: v + Math.sin(D) * R - y,
          top: v - Math.cos(D) * R - y
        }),
        z.html(0 === I ? "00" : I),
        f.append(z),
        z.on(r, W);
    ...
    for (I = 0; 60 > I; I += 5)
      ...
      D = I / 30 * Math.PI,
      z.css({
        left: v + Math.sin(D) * g - y,
        top: v - Math.cos(D) * g - y
      }),
      z.css("font-size", "140%"),
      z.html(d(I)),
      C.append(z),
  ...
  C.prototype.resetClock = function(t) {
    var e = this.currentView
      ...
      , c = -Math.cos(o) * r
      , u = this;
    s && t ? (u.canvas.addClass("clockpicker-canvas-out"),
    setTimeout(function() {
  ...
  C.prototype.setHand = function(e, i, n, a) {
    var v, o = Math.atan2(e, -i), r = "hours" === this.currentView, l = Math.PI / (r || n ? 6 : 30), c = Math.sqrt(e * e + i * i), h = this.options, f = r && (g + m) / 2 > c, p = f ? m : g;
    if (h.twelvehour && (p = g),
    0 > o && (o = 2 * Math.PI + o),
    v = Math.round(o / l),
    o = v * l,
    h.twelvehour ? r ? 0 === v && (v = 12) : (n && (v *= 5),
    60 === v && (v = 0)) : r ? (12 === v && (v = 0),
    v = f ? 0 === v ? 12 : v : 0 === v ? 0 : v + 12) : (n && (v *= 5),
    60 === v && (v = 0)),
    r ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : v % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"),
    this[this.currentView] !== v && u && this.options.vibrate && (this.vibrateTimer || (navigator[u](10),
    this.vibrateTimer = setTimeout(t.proxy(function() {
      this.vibrateTimer = null
    }, this), 100))),
    this[this.currentView] = v,
    this[r ? "spanHours" : "spanMinutes"].html(d(v)),
    !s)
      return void this[r ? "hoursView" : "minutesView"].find(".clockpicker-tick").each(function() {
        var e = t(this);
        e.toggleClass("active", v === +e.html())
      });
    a || !r && v % 5 ? (this.g.insertBefore(this.hand, this.bearing),
  ...
  t.fn.pickatime = function(e) {
    ...
    return this.each(function() {
      ...
      if (s)
        "function" == typeof s[e] && s[e].apply(s, i);
      else {
  ...
  t.fn.dropdown = function(e) {
    ...
    this.each(function() {
      ...
      function r() {
        o(),
        a.addClass("active"),
        s.constrain_width === !0 && a.css("width", n.outerWidth());
        var e = 0;
...
function(t) {
  t(document).ready(function() {
    ...
    t(document).on("change", e, function() {
      (0 !== t(this).val().length || void 0 !== t(this).attr("placeholder")) && t(this).siblings("label, i").addClass("active"),
    ...
    t(document).on("change", '.file-field input[type="file"]', function() {
      for (var e = t(this).closest(".file-field"), i = e.find("input.file-path"), n = t(this)[0].files, s = [], a = 0; a < n.length; a++)
        s.push(n[a].name);
      i.val(s.join(", ")),
      i.trigger("change")
    });
    var r, a = "input[type=range]", o = !1;
    t(a).each(function() {
  ...
  t.fn.material_select = function(e) {
    t(this).each(function() {
      ...
      !$select.hasClass("browser-default")) {
        ...
        if (i && ($select.parent().find("i").remove(),
        $select.parent().find("input").remove(),
        $select.unwrap(),
        t("ul#select-options-" + i).remove()),
        "destroy" === e)
        ...
        var r, a = t('<ul id="select-options-' + n + '" class="dropdown-content select-dropdown"></ul>'), o = $select.children("option");
        r = void 0 !== $select.find("option:selected") ? $select.find("option:selected") : a.first(),
        o.each(function() {
        ...
        a.find("li").each(function(i) {
          ...
          t(this).click(function() {
            t(this).hasClass("disabled") || (n.find("option").eq(i).prop("selected", !0),
            n.trigger("change"),
        ...
        c.before(l),
        t("body").append(a),
        $select.is(":disabled") || c.dropdown({
          hover: !1
        }),
        $select.attr("tabindex") && t(c[0]).attr("tabindex", $select.attr("tabindex")),
        ...
        onKeyDown = function(e) {
          if (9 == e.which)
            return void c.trigger("close");
          if (40 == e.which && !a.is(":visible"))
            return void c.trigger("open");
          if (13 != e.which || a.is(":visible")) {
            e.preventDefault(),
            letter = String.fromCharCode(e.which).toLowerCase();
            var i = [9, 13, 27, 38, 40];
            letter && -1 === i.indexOf(e.which) && (filterQuery.push(letter),
            ...
            13 == e.which && (activeOption = a.find("li.active:not(.disabled)")[0],
            activeOption && (t(activeOption).trigger("click"),
            c.trigger("close"))),
            40 == e.which && (newOption = a.find("li.active").next("li:not(.disabled)")[0],
            newOption && activateOption(a, newOption)),
            27 == e.which && c.trigger("close"),
            38 == e.which && (newOption = a.find("li.active").prev("li:not(.disabled)")[0],
            newOption && activateOption(a, newOption)),
            setTimeout(function() {
              filterQuery = []
            }, 1e3)
  ...
  if (!t.jQuery) {
    ...
    i.each = function(t, i, n) {
      ...
      if (n) {
        ...
        for (; o > a && (s = i.call(t[a], a, t[a]),
        s !== !1); a++)
          ;
      else
        for (a in t)
          if (s = i.call(t[a], a, t[a]),
          s === !1)
            break;
      return t
    }
    ...
    ,
    i.extend = function() {
      var t, e, n, s, a, o, r = arguments[0] || {}, l = 1, c = arguments.length, u = !1;
    ...
    i.queue = function(t, n, s) {
      ...
      if (t) {
        n = (n || "fx") + "queue";
        var o = i.data(t, n);
        return s ? (!o || i.isArray(s) ? o = i.data(t, n, a(s)) : o.push(s),
        o) : o || []
      }
    }
    ,
...
function(t) {
  ...
  return function(t, e, i, n) {
    ...
    function l(t, i, n, s) {
      ...
      function f(e) {
        for (var i = 0, s = 1, a = b - 1; s != a && k[s] <= e; ++s)
          i += w;
        --s;
      ...
      var k = x ? new Float32Array(b) : new Array(b)
        ...
        , P = function(e) {
        return S || p(),
        t === i && n === s ? e : 0 === e ? 0 : 1 === e ? 1 : l(f(e), i, s)
      }
      ;
    ...
    function c(t, e) {
      var i = t;
      return p.isString(t) ? b.Easings[t] || (i = !1) : i = p.isArray(t) && 1 === t.length ? r.apply(null , t) : p.isArray(t) && 2 === t.length ? w.apply(null , t.concat([e])) : p.isArray(t) && 4 === t.length ? l.apply(null , t) : !1,
          ...
          if (b.State.calls[a]) {
            ...
            for (var m = Math.min((e - d) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
              ...
              if (o(S)) {
                ...
                for (var A in C)
                  if ("element" !== A) {
                    var O, M = C[A], E = p.isString(M.easing) ? b.Easings[M.easing] : M.easing;
                    if (1 === m)
                      O = M.endValue;
                    else {
                      var L = M.endValue - M.startValue;
                      if (O = M.startValue + L * E(m, c, L),
                      !f && O === M.currentValue)
                        continue
                    }
                    if (M.currentValue = O,
                    "tween" === A)
                      ...
                      x.Hooks.registered[A] && (o(S).rootPropertyValueCache[F] = x.Normalizations.registered[F] ? x.Normalizations.registered[F]("extract", null , z[1]) : z[1]),
                      "transform" === z[0] && (P = !0)
                    }
                  }
            ...
            c.progress && c.progress.call(r[1], r[1], m, Math.max(0, d + c.duration - e), d, g),
            1 === m && h(a)
          }
      }
    ...
    function h(t, e) {
      ...
      for (var i = b.State.calls[t][0], s = b.State.calls[t][1], a = b.State.calls[t][2], r = b.State.calls[t][4], l = !1, c = 0, u = i.length; u > c; c++) {
        ...
        a.loop !== !0 && (v.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(v.queue(h)[1])) && o(h)) {
          o(h).isAnimating = !1,
          ...
          v.each(x.Lists.transforms3D, function(t, e) {
            ...
            o(h).transformCache[e] !== n && new RegExp("^\\(" + i + "[^.]").test(s) && (d = !0,
            delete o(h).transformCache[e])
          }),
          a.mobileHA && (d = !0,
          delete o(h).transformCache.translate3d),
          d && x.flushTransformCache(h),
        ...
        r && a.loop !== !0 && r(s),
        o(h) && a.loop === !0 && !e && (v.each(o(h).tweensContainer, function(t, e) {
    ...
    if (t.fn && t.fn.jquery ? (v = t,
    g = !0) : v = e.Velocity.Utilities,
    8 >= d && !g)
    ...
    var x = b.CSS = {
      ...
      Hooks: {
        ...
        extractValue: function(t, e) {
          ...
          if (i) {
            ...
            e.toString().match(x.RegEx.valueSplit)[s]
          }
          return e
        },
            ...
            !function() {
              ...
              x.Normalizations.registered[e] = function(t, i, s) {
                ...
                case "inject":
                  ...
                  case "scal":
                  case "scale":
                    b.State.isAndroid && o(i).transformCache[e] === n && 1 > s && (s = 1),
                    a = !/(\d)$/i.test(s);
                    break;
                  case "skew":
                    a = !/(deg|\d)$/i.test(s);
            ...
            !function() {
              ...
              x.Normalizations.registered[e] = function(t, i, s) {
                ...
                case "extract":
                  ...
                  a;
                case "inject":
                  return 8 >= d ? 4 === s.split(" ").length && (s = s.split(/\s+/).slice(0, 3).join(" ")) : 3 === s.split(" ").length && (s += " 1"),
                  (8 >= d ? "rgb" : "rgba") + "(" + s.replace(/\s+/g, ",").replace(/\.(\d)+(?=,)/g, "") + ")"
                }
              }
            }()
        }
      ...
      Names: {
        ...
        SVGAttribute: function(t) {
          ...
          return (d || b.State.isAndroid && !b.State.isChrome) && (e += "|transform"),
        ...
        prefixCheck: function(t) {
          ...
          for (var e = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = e.length; n > i; i++) {
            ...
            p.isString(b.State.prefixElement.style[s]))
              return b.State.prefixMatches[t] = s,
              [s, !0]
          }
          return [t, !1]
        }
      ...
      Values: {
        hexToRgb: function(t) {
          var n, e = /^#?([a-f\d])([a-f\d])([a-f\d])$/i, i = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i;
      ...
      getPropertyValue: function(t, i, s, a) {
        function r(t, i) {
          ...
          if (8 >= d)
            ...
            var f;
            f = o(t) === n ? e.getComputedStyle(t, null ) : o(t).computedStyle ? o(t).computedStyle : o(t).computedStyle = e.getComputedStyle(t, null ),
            "borderColor" === i && (i = "borderTopColor"),
            l = 9 === d && "filter" === i ? f.getPropertyValue(i) : f[i],
      ...
      setPropertyValue: function(t, i, n, s, a) {
        ...
        if ("scroll" === i)
          ...
          8 >= d)
            ...
            o(t) && o(t).isSVG && x.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[r] = n;
      ...
      flushTransformCache: function(t) {
        ...
        if ((d || b.State.isAndroid && !b.State.isChrome) && o(t).isSVG) {
          ...
          v.each(o(t).transformCache, function(e) {
            return s = o(t).transformCache[e],
            "transformPerspective" === e ? (a = s,
    ...
    var C = function() {
      ...
      function s() {
        function t(t) {
          function h(t, e) {
            ...
            !p.isArray(t[1]) && /^[\d-]/.test(t[1]) || p.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? r = t[1] : (p.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || p.isArray(t[1])) && (o = e ? t[1] : c(t[1], a.duration),
            t[2] !== n && (r = t[2]))) : i = t,
            e || (o = o || a.easing),
            p.isFunction(i) && (i = i.call(s, S, k)),
            p.isFunction(r) && (r = r.call(s, S, k)),
            [i || 0, o, r]
          }
          function d(t, e) {
            var i, n;
          ...
          function f() {
            ...
            var r = 100
              , l = {};
            if (a && n)
              l.emToPx = z.lastEmToPx,
              l.percentToPxWidth = z.lastPercentToPxWidth,
              l.percentToPxHeight = z.lastPercentToPxHeight;
            else {
              var c = o(s).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
              b.init(c),
              t.myParent.appendChild(c),
              v.each(["overflow", "overflowX", "overflowY"], function(t, e) {
              ...
              v.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function(t, e) {
                b.CSS.setPropertyValue(c, e, r + "%")
              }),
              b.CSS.setPropertyValue(c, "paddingLeft", r + "em"),
              l.percentToPxWidth = z.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(c, "width", null , !0)) || 1) / r,
              l.percentToPxHeight = z.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(c, "height", null , !0)) || 1) / r,
              l.emToPx = z.lastEmToPx = (parseFloat(x.getPropertyValue(c, "paddingLeft")) || 1) / r,
              t.myParent.removeChild(c)
            }
            return null  === z.remToPx && (z.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16),
            null  === z.vwToPx && (z.vwToPx = parseFloat(e.innerWidth) / 100,
          ...
          if ("scroll" === M) {
            var T, O, E, C = /^x$/i.test(a.axis) ? "Left" : "Top", P = parseFloat(a.offset) || 0;
            a.container ? p.isWrapped(a.container) || p.isNode(a.container) ? (a.container = a.container[0] || a.container,
            T = a.container["scroll" + C],
            E = T + v(s).position()[C.toLowerCase()] + P) : a.container = null  : (T = b.State.scrollAnchor[b.State["scrollProperty" + C]],
            O = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === C ? "Top" : "Left")]],
            E = v(s).offset()[C.toLowerCase()] + P),
            r = {
              scroll: {
                rootPropertyValue: !1,
                startValue: T,
            ...
            if (!o(s).tweensContainer)
              return void v.dequeue(s, a.queue);
            ...
            a = v.extend({}, o(s).opts, a);
            var L = v.extend(!0, {}, o(s).tweensContainer);
            for (var F in L)
              if ("element" !== F) {
                var I = L[F].startValue;
                L[F].startValue = L[F].currentValue = L[F].endValue,
                L[F].endValue = I,
                p.isEmptyObject(w) || (L[F].easing = a.easing),
                b.debug && console.log("reverse tweensContainer (" + F + "): " + JSON.stringify(L[F]), s)
              }
            r = L
          } else if ("start" === M) {
            var L;
            o(s).tweensContainer && o(s).isAnimating === !0 && (L = o(s).tweensContainer),
            ...
            for (var R in y) {
              ...
              var H = x.Hooks.getRoot(R)
                , j = !1;
              if (o(s).isSVG || "tween" === H || x.Names.prefixCheck(H)[1] !== !1 || x.Normalizations.registered[H] !== n) {
                (a.display !== n && null  !== a.display && "none" !== a.display || a.visibility !== n && "hidden" !== a.visibility) && /opacity|filter/.test(R) && !$ && 0 !== W && ($ = 0),
                a._cacheValues && L && L[R] ? ($ === n && ($ = L[R].endValue + L[R].unitType),
                j = o(s).rootPropertyValueCache[H]) : x.Hooks.registered[R] ? $ === n ? (j = x.getPropertyValue(s, H),
                $ = x.getPropertyValue(s, R, j)) : j = x.Hooks.templates[H][1] : $ === n && ($ = x.getPropertyValue(s, R));
                var B, N, q, Q = !1;
                if (B = d(R, $),
                $ = B[0],
                q = B[1],
                B = d(R, W),
                W = B[0].replace(/^([+-\/*])=/, function(t, e) {
                  return Q = e,
                  ""
                }),
                N = B[1],
                $ = parseFloat($) || 0,
                W = parseFloat(W) || 0,
                "%" === N && (/^(fontSize|lineHeight)$/.test(R) ? (W /= 100,
                N = "em") : /^scale/.test(R) ? (W /= 100,
                N = "") : /(Red|Green|Blue)$/i.test(R) && (W = W / 100 * 255,
                N = "")),
                /[\/*]/.test(Q))
                  N = q;
                else if (q !== N && 0 !== $)
                  if (0 === W)
                    ...
                    switch (q) {
                    case "%":
                      $ *= "x" === X ? l.percentToPxWidth : l.percentToPxHeight;
                      break;
                    case "px":
                      break;
                    default:
                    ...
                    switch (N) {
                    case "%":
                      $ *= 1 / ("x" === X ? l.percentToPxWidth : l.percentToPxHeight);
                      break;
                    case "px":
                      break;
                    default:
                ...
                b.debug && console.log("tweensContainer (" + R + "): " + JSON.stringify(r[R]), s)
              } else
                b.debug && console.log("Skipping [" + H + "] due to a lack of browser support.")
            }
            r.element = s
          }
          r.element && (x.Values.addClass(s, "velocity-animating"),
          D.push(r),
          "" === a.queue && (o(s).tweensContainer = r,
          o(s).opts = a),
          o(s).isAnimating = !0,
          S === k - 1 ? (b.State.calls.push([D, g, a, null , A.resolver]),
          b.State.isTicking === !1 && (b.State.isTicking = !0,
          u())) : S++)
        }
        var l, s = this, a = v.extend({}, b.defaults, w), r = {};
        switch (o(s) === n && b.init(s),
        parseFloat(a.delay) && a.queue !== !1 && v.queue(s, a.queue, function(t) {
        ...
        b.mock !== !1 && (b.mock === !0 ? a.duration = a.delay = 1 : (a.duration *= parseFloat(b.mock) || 1,
        a.delay *= parseFloat(b.mock) || 1)),
        ...
        "auto" === a.display && (a.display = b.CSS.Values.getDisplayType(s))),
        ...
        a.queue === !1 ? a.delay ? setTimeout(t, a.delay) : t() : v.queue(s, a.queue, function(e, i) {
          return i === !0 ? (A.promise && A.resolver(g),
      ...
      if (p.isWrapped(this) ? (l = !1,
      f = 0,
      g = this,
      d = this) : (l = !0,
      f = 1,
      g = r ? arguments[0].elements || arguments[0].e : arguments[0]),
      g = a(g)) {
        r ? (y = arguments[0].properties || arguments[0].p,
          ...
          return v.each(b.State.calls, function(t, e) {
            e && v.each(e[1], function(i, s) {
              ...
              return a === !0 || e[2].queue === a || w === n && e[2].queue === !1 ? void v.each(g, function(i, n) {
                ...
                v.queue(n, p.isString(w) ? w : "", [])),
                "stop" === y ? (o(n) && o(n).tweensContainer && a !== !1 && v.each(o(n).tweensContainer, function(t, e) {
          ...
          if (!v.isPlainObject(y) || p.isEmptyObject(y)) {
            if (p.isString(y) && b.Redirects[y]) {
              var E = v.extend({}, w)
                , L = E.duration
                , F = E.delay || 0;
              return E.backwards === !0 && (g = v.extend(!0, [], g).reverse()),
              v.each(g, function(t, e) {
                parseFloat(E.stagger) ? E.delay = F + parseFloat(E.stagger) * t : p.isFunction(E.stagger) && (E.delay = F + E.stagger.call(e, t, k)),
                E.drag && (E.duration = parseFloat(L) || (/^(callout|transition)/.test(y) ? 1e3 : m),
                E.duration = Math.max(E.duration * (E.backwards ? 1 - t / k : (t + 1) / k), .75 * E.duration, 200)),
                b.Redirects[y].call(e, e, E || {}, t, k, g, A.promise ? A : n)
              }),
              t()
            }
            var I = "Velocity: First argument (" + y + ") was not a property map, a known action, or a registered redirect. Aborting.";
            return A.promise ? A.rejecter(new Error(I)) : console.log(I),
            t()
          }
          M = "start"
        }
...
function(t) {
  ...
  function u(e) {
    var i = c(e);
    null  !== i && (r.show(e, i),
    "ontouchstart" in t && (i.addEventListener("touchend", r.hide, !1),
    i.addEventListener("touchcancel", r.hide, !1)),
  ...
  var e = e || {}
    ...
    show: function(t, e) {
      ...
      "touches" in t && (l = t.touches[0].pageY - s.top,
      c = t.touches[0].pageX - s.left),
      ...
      h.transform = u,
      h.opacity = "1",
      h["-webkit-transition-duration"] = r.duration + "ms",
      h["-moz-transition-duration"] = r.duration + "ms",
      h["-o-transition-duration"] = r.duration + "ms",
      h["transition-duration"] = r.duration + "ms",
      h["-webkit-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)",
      h["-moz-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)",
      h["-o-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)",
      h["transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)",
      n.setAttribute("style", o(h))
    },
    hide: function(t) {
      l.touchup(t);
      ...
      for (var e = 0; e < t.length; e++) {
        ...
        if ("input" === i.tagName.toLowerCase()) {
          ...
          if ("i" === n.tagName.toLowerCase() && -1 !== n.className.indexOf("waves-effect"))
            continue;var s = document.createElement("i");
    ...
    allowEvent: function(t) {
      ...
      }, 500) : "mousedown" === t.type && l.touches > 0 && (e = !1),
      e
    },
    touchup: function(t) {
      l.allowEvent(t)
  ...
  e.attach = function(e) {
    ...
    e = e.parentElement),
    "ontouchstart" in t && e.addEventListener("touchstart", u, !1),
