          ...
          if ("scroll" === E) {
            ...
            for (var z in v) {
              ...
              if (s(a).isSVG || "tween" === N || x.Names.prefixCheck(N)[1] !== !1 || x.Normalizations.registered[N] !== n) {
                ...
                H = parseFloat(H) || 0,
                V = parseFloat(V) || 0,
                "%" === q && (/^(fontSize|lineHeight)$/.test(z) ? (V /= 100,
                q = "em") : /^scale/.test(z) ? (V /= 100,
                q = "") : /(Red|Green|Blue)$/i.test(z) && (V = V / 100 * 255,
                q = "")),
                /[\/*]/.test(Y))
                  q = $;
                else if ($ !== q && 0 !== H)
...
function() {
  ...
  i.Tooltip = i.Element.extend({
    draw: function() {
      ...
      t.font = $(this.fontSize, this.fontStyle, this.fontFamily),
      this.xAlign = "center",
      this.yAlign = "above";
  ...
  i.MultiTooltip = i.Element.extend({
    initialize: function() {
      this.font = $(this.fontSize, this.fontStyle, this.fontFamily),
      this.titleFont = $(this.titleFontSize, this.titleFontStyle, this.titleFontFamily),
  ...
  i.RadialScale = i.Element.extend({
    ...
    setScaleSize: function() {
      ...
      for (this.ctx.font = $(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily),
      ...
      if (this.display) {
        ...
        if (o(this.yLabels, function(e, i) {
          if (i > 0) {
            ...
            if (this.showLabels) {
              if (t.font = $(this.fontSize, this.fontStyle, this.fontFamily),
        ...
        !this.lineArc) {
          ...
          for (var e = this.valuesCount - 1; e >= 0; e--) {
            ...
            t.font = $(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily),
...
!function(t, e, i, n) {
  ...
  function x(t, e) {
    for (var i, o, a = e[0].toUpperCase() + e.slice(1), s = 0; s < lt.length; ) {
      if (i = lt[s],
      o = i ? i + a : e,
      o in t)
        return o;
  ...
  function P(t) {
    ...
    return new (e = i ? i : gt ? W : yt ? B : vt ? q : V)(t,T)
  }
  function T(t, e, i) {
  ...
  function A(t, e) {
    ...
    o > 1 && !i.firstMultiple ? i.firstMultiple = I(e) : 1 === o && (i.firstMultiple = !1);
    var a = i.firstInput
      , s = i.firstMultiple
    ...
    e.scale = s ? _(s.pointers, n) : 1,
    e.rotation = s ? z(s.pointers, n) : 0,
    M(i, e);
    var c = t.element;
  ...
  function E(t, e) {
    var i = e.center
      ...
      , o = t.prevDelta || {}
      , a = t.prevInput || {};
    (e.eventType === St || a.eventType === Tt) && (o = t.prevDelta = {
      x: a.deltaX || 0,
      y: a.deltaY || 0
    },
    n = t.offsetDelta = {
  ...
  function M(t, e) {
    var i, o, a, s, r = t.lastInterval || e, l = e.timeStamp - r.timeStamp;
  ...
  function L(t, e) {
    return t === e ? Et : dt(t) >= dt(e) ? t > 0 ? Mt : It : e > 0 ? Ot : Ft
  }
  function D(t, e, i) {
    i || (i = zt);
    var n = e[i[0]] - t[i[0]]
  ...
  function z(t, e) {
    return R(e[1], e[0], _t) - R(t[1], t[0], _t)
  }
  function _(t, e) {
    return D(e[0], e[1], _t) / D(t[0], t[1], _t)
  }
  function V() {
    this.evEl = Wt,
    this.evWin = Ht,
  ...
  function j(t, e) {
    ...
    if (e & (St | Pt) && 1 === i.length)
      ...
      [i, i];
    var o, a, s = b(t.changedTouches), r = [], l = this.target;
    ...
    for (o = 0; o < s.length; )
      ...
      e & (Tt | At) && delete n[s[o].identifier],
      o++;
  ...
  function q() {
    ...
    this.mouse = new V(this.manager,t)
  }
  function $(t, e) {
    this.manager = t,
    this.set(e)
  ...
  function Q(t) {
    return t & ce ? "cancel" : t & re ? "end" : t & se ? "move" : t & ae ? "start" : ""
  }
  function Z(t) {
    return t == Ft ? "down" : t == Ot ? "up" : t == Mt ? "left" : t == It ? "right" : ""
  }
  function G(t, e) {
    var i = e.manager;
    return i ? i.get(t) : t
  ...
  function ot(t, e) {
    return e = e || {},
    e.recognizers = d(e.recognizers, ot.defaults.preset),
    new at(t,e)
  }
  function at(t, e) {
    e = e || {},
  ...
  var lt = ["", "webkit", "moz", "MS", "ms", "o"]
    ...
    , gt = x(t, "PointerEvent") !== n
    , yt = vt && mt.test(navigator.userAgent)
    , bt = "touch"
    , wt = "pen"
    , xt = "mouse"
    , Ct = "kinect"
  ...
  t.MSPointerEvent && (jt = "MSPointerDown",
  ...
  c(W, S, {
    handler: function(t) {
      ...
      o & St && (0 === t.button || s) ? 0 > r && (e.push(t),
      r = e.length - 1) : o & (Tt | At) && (i = !0),
      0 > r || (e[r] = t,
  ...
  $.prototype = {
    set: function(t) {
      t == Kt && (t = this.compute()),
      Ut && (this.manager.element.style[Gt] = t),
    ...
    preventDefaults: function(t) {
      if (!Ut) {
        ...
        var n = this.actions
          ...
          , a = v(n, ne)
          , s = v(n, ie);
        return o || a && i & Lt || s && i & Dt ? this.preventSrc(e) : void 0
      }
    },
  ...
  X.prototype = {
    ...
    canEmit: function() {
      for (var t = 0; t < this.requireFail.length; ) {
        if (!(this.requireFail[t].state & (ue | oe)))
          return !1;
        t++
      }
      return !0
    ...
    recognize: function(t) {
      var e = r({}, t);
      return h(this.options.enable, [this, e]) ? (this.state & (le | ce | ue) && (this.state = oe),
      this.state = this.process(e),
      void (this.state & (ae | se | re | ce) && this.tryEmit(e))) : (this.reset(),
      void (this.state = ue))
    },
    process: function() {},
  ...
  c(U, X, {
    ...
    process: function(t) {
      var e = this.state
        ...
        , n = e & (ae | se)
        , o = this.attrTest(t);
      return n && (i & At || !o) ? e | ce : n || o ? i & Tt ? e | re : e & ae ? e | se : ae : ue
    }
  }),
  c(K, U, {
    defaults: {
    ...
    directionTest: function(t) {
      var e = this.options
        ...
        , a = t.deltaX
        , s = t.deltaY;
      return o & e.direction || (e.direction & Lt ? (o = 0 === a ? Et : 0 > a ? Mt : It,
      i = a != this.pX,
      n = Math.abs(t.deltaX)) : (o = 0 === s ? Et : 0 > s ? Ot : Ft,
      i = s != this.pY,
      n = Math.abs(t.deltaY))),
      t.direction = o,
    ...
    attrTest: function(t) {
      return U.prototype.attrTest.call(this, t) && (this.state & ae || !(this.state & ae) && this.directionTest(t))
    },
    emit: function(t) {
      this.pX = t.deltaX,
      this.pY = t.deltaY;
  ...
  c(it, U, {
    ...
    attrTest: function(t) {
      ...
      return i & (Lt | Dt) ? e = t.velocity : i & Lt ? e = t.velocityX : i & Dt && (e = t.velocityY),
    ...
    process: function(t) {
      ...
      if (n && a && i) {
        ...
        var s = this.pTime ? t.timeStamp - this.pTime < e.interval : !0
          , r = !this.pCenter || D(this.pCenter, t.center) < e.posThreshold;
    ...
    recognize: function(t) {
      ...
      if (!e.stopped) {
        ...
        for (var a = 0; a < n.length; )
          i = n[a],
          e.stopped === de || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t),
          !o && i.state & (ae | se | re) && (o = e.curRecognizer = i),
          a++
      }
    },
    get: function(t) {
...
function() {
  ...
  function C(e, n) {
    ...
    o) {
      ...
      q.setAttribute("r", y);
      var $ = h("circle");
      $.setAttribute("class", "clockpicker-canvas-fg"),
      $.setAttribute("r", 5),
      N.appendChild(j),
      N.appendChild(q),
      N.appendChild($),
  ...
  var t = function(t, e, i, n) {
    ...
    , Be = function(t) {
      if (W.isOldAndroid) {
        if ($ && "mouseup" === t.type)
          return;
        t.type.indexOf("touch") > -1 && (clearTimeout($),
        $ = setTimeout(function() {
          $ = 0
        }, 600))
      }
      ...
      Z || Q || ot || q)
        ...
        q) {
          ...
          if (!ot)
            return "swipe" !== s ? void Xe() : void (!U && y > a.currItem.fitRatio && qe(B))
        }
    }
    , je = function() {
      var t, e, i = {
...
!function(t, e) {
  ...
  var t = function(t, e) {
    var i, n, o, a, s, r, l, c, u, h, d, f, p, m, v, g, y, b, w, x = this, C = !1, k = !0, S = !0, P = {
      ...
      for (var i, n, o = t.target || t.srcElement, a = o.getAttribute("class") || "", s = 0; s < q.length; s++)
        i = q[s],
